            ...
            try {
                ...
                (manualData || []).forEach((item: any) => {
                    if (item.practical_id) {
                        ...
                        if (item.status) manualStatusMap.set(item.practical_id, item.status);
                    }
                });
                ...
                const progressData = Array.from(subjectMap.entries()).map(([sid, data]) => ({
            ...
            <div className="pt-24 pb-12 px-4 sm:px-6 lg:px-8 xl:px-12 w-full mx-auto">
                ...
                >
                    <div className="space-y-1">
                        <h1 className="text-3xl font-black text-gray-900 dark:text-white tracking-tight">
                            Welcome back, <span className="text-gradient">{userName || (loading ? "..." : (user?.user_metadata?.name || "Student"))}</span> 👋
                        </h1>
                ...
                {loading || !user ? (
                    ...
                    >
                        ...
                        <motion.div variants={itemVariants} className="md:col-span-2 grid grid-cols-2 gap-4">
                            <Link
                                href="/Interactive"
                        ...
                        <motion.div variants={itemVariants} className="md:col-span-2 glass-card rounded-3xl p-6">
                        ...
                        <motion.div variants={itemVariants} className="md:col-span-2 lg:col-span-4 glass-card rounded-3xl p-6">
                            <div className="flex items-center justify-between mb-5">
                                <div className="flex items-center gap-2">
