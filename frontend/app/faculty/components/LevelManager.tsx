...
import { Sparkles, FlaskConical as TestIcon, Plus as PlusIcon, Trash2 as TrashIcon } from "lucide-react";
...
interface LevelManagerProps {
    ...
    updateLevelField: (level: 'easy' | 'medium' | 'hard', field: string, value: string | number | boolean) => void;
    addLevelTestCase: (level: 'easy' | 'medium' | 'hard') => void;
    removeLevelTestCase: (level: 'easy' | 'medium' | 'hard', index: number) => void;
    updateLevelTestCase: (level: 'easy' | 'medium' | 'hard', index: number, field: keyof TestCase, value: string | number | boolean) => void;
            ...
            <AnimatePresence mode="wait">
              ...
              Actually, the original implementation shared one sampleCode. We'll keep it simple. */}
                    ...
                    <TestCaseManager
                        ...
                        handleTestCaseChange={(idx, field, val) => updateLevelTestCase(activeLevel, idx, field, val)}
