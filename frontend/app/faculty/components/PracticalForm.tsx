                            ...
                            <div className="space-y-3 max-h-[300px] overflow-y-auto">
                              {getCurrentLevel().testCases.map((tc, i) => (
                                <motion.div
                                  ...
                                  className="bg-white/50 dark:bg-gray-900/50 rounded-lg p-3 border border-gray-200 dark:border-gray-700">
                          ...
                          <div className="space-y-3 flex-1 overflow-y-auto max-h-[400px] pr-2 custom-scrollbar">
                            ...
                            {testCases.map((tc, i) => (
                              <motion.div
                                ...
                                animate={{ opacity: 1, y: 0 }}
                                transition={{ delay: i * 0.05 }}
                                className="bg-white dark:bg-gray-800 rounded-xl p-3 border border-gray-200 dark:border-gray-700 space-y-2">
                      ...
                      <div className="max-h-96 overflow-y-auto">
                        {error ? (
                          ...
                          <div className="flex flex-col items-center justify-center py-12 px-4">
                            ...
                            {filters.query && (
                              <motion.button onClick={() => setFilters(prev => ({ ...prev, query: "" }))}
                                whileHover={{ scale: 1.02 }}
                                whileTap={{ scale: 0.98 }}
                            ...
                            {filteredStudents.map(student => {
                              ...
                              return (
                                <motion.div
                                  ...
                                  animate={{ opacity: 1, x: 0 }}
                                  transition={{ delay: 0.05 * (student.roll ? 1 : 0) }} // Simple stagger
