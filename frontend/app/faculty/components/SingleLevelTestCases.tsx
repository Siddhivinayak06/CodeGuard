        ...
        <>
            ...
            <div className="glass-card-premium rounded-2xl p-5 shadow-sm">
                <div className="flex items-center gap-3 pb-3 border-b border-gray-200 dark:border-gray-700 mb-4">
                    ...
                    <div>
                        <h3 className="font-bold text-gray-900 dark:text-white">Problem Description</h3>
                        <p className="text-xs text-gray-500 dark:text-gray-400">Detailed explanation of the practical task</p>
                    </div>
                </div>
                <textarea
                    name="description"
                ...
                <div className="flex items-center justify-between pb-3 border-b border-gray-200 dark:border-gray-700 mb-4">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-xs text-gray-500 dark:text-gray-400">Provide a starting template or solution</p>
                        </div>
                    </div>
                    <select
