        ...
        <div className="flex-1 min-w-0 space-y-3">
          <div>
            ...
            <div className="flex flex-wrap items-center gap-2">
              <span className="inline-flex items-center gap-1.5 px-3 py-1 bg-gradient-to-br from-cyan-500/10 to-sky-500/10 dark:from-cyan-500/20 dark:to-sky-500/20 border border-cyan-500/20 dark:border-cyan-500/30 text-cyan-700 dark:text-cyan-300 text-xs font-medium rounded-full backdrop-blur-sm">
                {subject}
              </span>
