  ...
  return (
    ...
    >
      <div className="flex items-center justify-between mb-4 h-7">
        <h3
          className={`font-semibold text-sm ${isCurrentMonth ? "text-indigo-700 dark:text-indigo-300" : "text-gray-700 dark:text-gray-300"}`}
        >
          {months[monthIndex]}
        </h3>
      ...
      <div className="grid grid-cols-7 gap-1 text-center text-xs">
        {["Su", "Mo", "Tu", "We", "Th", "Fr", "Sa"].map((d) => (
          <div
            key={d}
            className="text-gray-400 dark:text-gray-500 font-medium py-1 text-[10px]"
          >
            {d}
          </div>
        ))}
