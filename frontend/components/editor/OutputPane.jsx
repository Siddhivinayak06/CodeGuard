const formatError = (error) => {
  ...
  for (let line of lines) {
    ...
    if (line.includes('interactive_wrapper.py') || line.includes('File "<string>", line')) {
      ...
      <div className="h-full bg-white dark:bg-gray-900 flex flex-col">
        <div className="flex items-center justify-between px-4 py-2 bg-gray-50 dark:bg-gray-900/50 border-b border-gray-200/50 dark:border-gray-800/50">
          <div className="flex items-center gap-2">
            ...
            <span className="text-gray-500 dark:text-gray-400 text-xs font-mono uppercase tracking-wider">Console Output</span>
          </div>
        </div>
        ...
        <div className="flex-1 flex items-center justify-center text-gray-400 dark:text-gray-600">
          <div className="text-center">
            ...
            <p className="text-xs mt-1 opacity-70 italic">
              Run your {language} code to see results</p>
          </div>
        </div>
      </div>
    );
    ...
    <div className="h-full bg-white dark:bg-gray-900 flex flex-col font-mono text-sm">
      <div className="flex items-center justify-between px-4 py-2 bg-gray-50 dark:bg-gray-900/50 border-b border-gray-200/50 dark:border-gray-800/50">
        <div className="flex items-center gap-2">
          ...
          <span className="ml-2 text-gray-500 dark:text-gray-400 text-xs font-mono uppercase tracking-wider">Terminal Output</span>
        </div>
      </div>
