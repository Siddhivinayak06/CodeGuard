  ...
  if (!isRegistered.python) {
    monaco.languages.registerCompletionItemProvider("python", {
      provideCompletionItems: (model: ITextModel, position: Position) => {
        ...
        const snippetItems = pythonSnippets.map((s) =>
          createItem(
            s.label,
        ...
        return {
          suggestions: [...keywordItems, ...snippetItems].map((item) => ({
            ...item,
            range,
          })),
        };
  ...
  if (!isRegistered.c) {
    monaco.languages.registerCompletionItemProvider("c", {
      provideCompletionItems: (model: ITextModel, position: Position) => {
        ...
        const snippetItems = cppSnippets.map((s) =>
          createItem(
            s.label,
            monaco.languages.CompletionItemKind.Snippet,
            s.insertText,
  ...
  if (!isRegistered.java) {
    monaco.languages.registerCompletionItemProvider("java", {
      provideCompletionItems: (model: ITextModel, position: Position) => {
        ...
        const snippetItems = javaSnippets.map((s) =>
          createItem(
            s.label,
            monaco.languages.CompletionItemKind.Snippet,
            s.insertText,
